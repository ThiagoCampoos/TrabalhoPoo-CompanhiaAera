...
public class Main {
    public static void main(String[] args) {
        ...
        Passageiro maria = passageiroService.criar("Maria Souza", LocalDate.of(1985, 5, 20), "654321", "maria",
                "123");
        Voo voo1 = vooService.criar(1, "GRU", "SDU", LocalDate.of(2025, 12, 5), LocalTime.of(2, 0), latam, 150,
                EstadoVoo.PROGRAMADO, "2025-12-05T08:00", "2025-12-10T18:00");
        Voo voo2 = vooService.criar(2, "SDU", "GRU", LocalDate.of(2025, 12, 10), LocalTime.of(2, 0), azul, 120,
    ...
    private static void menuItinerario(Scanner sc, VooService vooService, TicketService ticketService,
        ...
        sc.nextLine();
        Ticket ticketIda = ticketService.criar(valorIda, vooIda, passageiro);
        ...
        if (vooVolta != null) {
            ...
            sc.nextLine();
            Ticket ticketVolta = ticketService.criar(valorVolta, vooVolta, passageiro);
            ...
            try {
                switch (opcao) {
                    case 1:
                        ...
                        Ticket novo = ticketService.criar(valor, voo, passageiro);
            ...
            try {
                switch (opcao) {
                    case 1:
                        ...
                        Voo novo = vooService.criar(id, origem, destino, data, duracao, companhia, capacidade, estado, ida, volta);
                        System.out.println("Criado: " + novo);
                        break;
                    case 2:
                    ...
                    case 8:
                        ...
                        System.out.print("ID da companhia aérea: ");
                        ...
                        Voo atualizado = vooService.atualizar(idAtualizar, novaOrigem, novoDestino, novaData,
                                novaDuracao, companhiaAtualizar, novaCapacidade, novoEstado, novaIda, novaVolta);
